...
from caption_data import get_sp_loader
...
class Trainer(TrainerBase):
    def __init__(self, args, train_loader=None, val_loader=None, test_loader=None, train=True):
        ...
        from caption_model import VLT5VRDCaption, VLBartVRDCaption
    ...
    def only_predict(self):
        ...
        with torch.no_grad():
            ...
            res = []
            for i, c in zip(img_id, predictions):
                res.append({
                    "img_id": i,
                    "caption": c,
                })
            import json
            json.dump(res, open('spall_pred_baseline_bart.json',"w"))
